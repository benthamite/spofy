...
- ~spofy-playing~ marks the currently playing track in any listing.  It uses bold weight and the Spotify green color (=#1DB954=).  All columns of the playing row use this face, including the duration column.
